...
To select the indices `c("a", "a", "b")`, whilst ensuring **all** indices with those names get selected, once needs to do the following in base 'R':
...
# using 'squarebrackets' (shorter and more readable, and FASTER):
ss_x(x, c("a", "a"), 3L)
