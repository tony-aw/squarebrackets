...
#   case TYPESXP:
#   {
#     return rcpp_extract_array_DTYPEd_template<TYPESXP>(as<RCPPTYPEVector>(x), <inputs>, dimcumprod);
#   }
# "
# 
...
# //' @keywords internal
# //' @noRd
# // [[Rcpp::export(.rcpp_extract_array_DTYPEd_atomic)]]
# SEXP rcpp_extract_array_DTYPEd_atomic(
#   SEXP x, <args>, SEXP dimcumprod
# ) {
#   
#   
#   switch(TYPEOF(x)){
...
# templatecode <- "
# 
# template<int RTYPE> Vector<RTYPE> rcpp_extract_array_DTYPEd_template(
#   Vector<RTYPE> x, <args>, SEXP dimcumprod
# ) {
# 
# <setlengths>
# <make_pointers>
...
# pdim = REAL(dimcumprod);
# 
# Vector<RTYPE> out(<setlength_mult>);
# 
# R_xlen_t flatind = 0;
# 
# R_xlen_t counter = 0;
...
# 
# 
# fileConn <- file("src/dynamic_rcpp_extract_array_d.cpp")
# writeLines(rcpp_code, fileConn)
# close(fileConn)
# 
# 
