...
# NOTE:
# ss_set.default uses Rcpp code generated from the same string as the Rcpp code for ss2ii.
...
for(iSample in 1:10) {
  for(iDim in 2:9) {
    ...
    ind <- squarebrackets:::.ss2ii_general32(sub, x.dim)
...
for(iSample in 1:10) {
  for(iDim in 2:9) {
    ...
    ind <- squarebrackets:::.ss2ii_general64(sub, x.dim)
