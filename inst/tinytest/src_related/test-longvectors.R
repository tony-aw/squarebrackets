...
# C_any_neg ====
expect_false(
  squarebrackets:::.C_any_neg(c(0, 2^31 + 10))
)
expect_true(
  squarebrackets:::.C_any_neg(rep(-2^31 - 10, 10))
)
...
# C_any_nonpos ====
expect_false(
  squarebrackets:::.C_any_nonpos(rep(2^31 + 10, 10))
)
expect_true(
  squarebrackets:::.C_any_nonpos(rep(-2^31 - 10, 10))
)
expect_true(
  squarebrackets:::.C_any_nonpos(rep(0, 10))
)
...
# C_any_badindx ====
expect_false( # false
  squarebrackets:::.C_any_badindx(1:10, 2^31 + 10) 
)
expect_true( # true because zero
  squarebrackets:::.C_any_badindx(0:10, 11) 
)
expect_true( # true because negative
  squarebrackets:::.C_any_badindx(-1:-10, 11) 
)
expect_true( # true because out of bounds
  squarebrackets:::.C_any_badindx(rep(2^31 + 10, 10), 11) 
)
...
# C_any_badmargin ====
expect_false( # false
  squarebrackets:::.C_any_badmargin(0:10, 2^31 + 10) 
)
expect_true( # true because negative
  squarebrackets:::.C_any_badmargin(-1:10, 11) 
)
expect_true( # true because out of bounds
  squarebrackets:::.C_any_badmargin(rep(2^31 + 10, 10), 11) 
)
expect_true( # true because negative AND out of bounds
  squarebrackets:::.C_any_badmargin(rep(-2^31 - 10, 10), 11)
)
