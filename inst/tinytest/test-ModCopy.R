...
i <- c(1, 3)
z <- fi2_mod(x, i = i, tf = \(x)x[1])

az <- sapply(fi2_x(z, i = i), data.table::address)
ax <- sapply(fi2_x(x, i = i), data.table::address)
ay <- sapply(fi2_x(y, i = i), data.table::address)
...
az <- sapply(fi2_wo(z, i = i), data.table::address)
ax <- sapply(fi2_wo(x, i = i), data.table::address)
ay <- sapply(fi2_wo(y, i = i), data.table::address)
