...
i <- c(1, 3)
z <- ii2_mod(x, i = i, tf = \(x)x[1])

az <- sapply(ii2_x(z, i = i), data.table::address)
ax <- sapply(ii2_x(x, i = i), data.table::address)
ay <- sapply(ii2_x(y, i = i), data.table::address)
...
az <- sapply(ii2_wo(z, i = i), data.table::address)
ax <- sapply(ii2_wo(x, i = i), data.table::address)
ay <- sapply(ii2_wo(y, i = i), data.table::address)
