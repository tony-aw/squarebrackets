...
dim(y)
print(y)
ss2_x(y, n(1:3, 1:2), 1:ndim(y)) # vectorized selection of multiple recursive elements
...
dim(y)
print(y)
ss2_x(y, n(1:2, 1:3), 1:ndim(y))  # vectorized selection of multiple recursive elements
...
ss2_x(y, n(1:nrow(y), 1L), 1:ndim(y)) |> drop() |> print() # vectorized, fast
