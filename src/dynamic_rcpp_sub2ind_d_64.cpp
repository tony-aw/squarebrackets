...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_2d_64)]]
SEXP C_sub2ind_2d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2));
pout = REAL(out);
...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_3d_64)]]
SEXP C_sub2ind_3d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2 * len3));
pout = REAL(out);
...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_4d_64)]]
SEXP C_sub2ind_4d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2 * len3 * len4));
pout = REAL(out);
...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_5d_64)]]
SEXP C_sub2ind_5d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2 * len3 * len4 * len5));
pout = REAL(out);
...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_6d_64)]]
SEXP C_sub2ind_6d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2 * len3 * len4 * len5 * len6));
pout = REAL(out);
...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_7d_64)]]
SEXP C_sub2ind_7d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2 * len3 * len4 * len5 * len6 * len7));
pout = REAL(out);
...
//' @keywords internal
//' @noRd
// [[Rcpp::export(.C_sub2ind_8d_64)]]
SEXP C_sub2ind_8d_64(
...
double *pout;
SEXP out = PROTECT(Rf_allocVector(REALSXP, len1 * len2 * len3 * len4 * len5 * len6 * len7 * len8));
pout = REAL(out);
