...
## Changelog (EXPERIMENTAL VERSIONS)
 ...
 - 1 April 2024: Added `inv` argument to `sb_mod()`/`sb2_mod()` and `sb_set()`/`sb2_set()`, and added tests for these. Added `idx1()` for Copy-On-Modification Substitution, and added tests for `idx1()` also.
