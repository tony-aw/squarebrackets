...
#'  - **copy semantics**: copying atomic data (almost) always performs a *deep copy*
#'  (though this statement comes with some technical caveats). \cr
#'  But since recursive objects are pointers to other data,
#'  copies of recursive objects are often *shallow copies*.
