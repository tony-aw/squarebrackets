...
#' 
#'  - `ii_`: operates on subsets of \bold{atomic} objects by \bold{flat/interior} indices.
...
#' 
#'  - `ii2_x(y, i)` corresponds to `y[i]` or `y[[i]]`
#'  (depending on the arguments given in `ii2_x()`)
