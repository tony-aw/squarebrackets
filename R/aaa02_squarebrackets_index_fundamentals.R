...
#'  These primarily use the \link[=squarebrackets_index_args]{i, use} argument pair. \cr
...
#'  These primarily use the the \link[=squarebrackets_index_args]{s, use} argument pair.
#'  
#'  - One can operate on tabular tiles
#'  using the  \link[=squarebrackets_methods]{tt_} methods; \cr
#'  These primarily use the the
#'  \link[=squarebrackets_index_args]{row, col, use}
#'  argument pair. \cr \cr
#' 
#' 
