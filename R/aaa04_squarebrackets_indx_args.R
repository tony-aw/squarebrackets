...
#'  i_x(x, i = i) # ==> x[i]   # if `x` is atomic
#'  i2_x(x, i = i) # ==> x[i]  # if `x` is recursive
#'  
#' ```
#' 
...
#' 
#' ```{r eval = FALSE, echo = TRUE}
#'  i_x(x, i = i) # ==> x[i(x)] # if `x` is atomic
#'  i2_x(x, i = i) # ==> x[lapply(x, i)] # if `x` is recursive
#'  
#' ```
#' 
#' 
