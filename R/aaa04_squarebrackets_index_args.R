...
#' see \link{squarebrackets_index_fundamentals}. \cr
...
#' is the primary indexing argument for sub-set operations on atomic arrays or recursive arrays. \cr
#' \cr
...
#' 
#' Specifies rows and columns in an atomic matrix, a recursive matrix, or data.frame.
