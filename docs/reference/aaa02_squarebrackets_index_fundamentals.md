...
- One can operate on flat/interior indices (often simply referred to as
  ...
  use](https://tony-aw.github.io/squarebrackets/reference/aaa04_squarebrackets_index_args.md)
  argument pair.  
...
When inverting indices, the order of the indices and the presence of
...
- Character indices that specify non-existing names or `NA` returns an
  error.  
...
I.e.
[ii_x](https://tony-aw.github.io/squarebrackets/reference/generic_x.md)`(x, 1)`,
